...
public interface BaseDao<T> {
     ...
     */
    void addObject(String statementName, T obj) throws DataAccessException;
     ...
     * @throws DataAccessException
     */
    int updateObject(String statementName, T obj) throws DataAccessException;
     ...
     * @return
     */
    List<T> listByPage(String statementName, Map<String, Object> map, int skipResults, int pageSize);
     ...
     * @return
     */
    List<T> listByPage(String statementName, String filter, int skipResults, int pageSize);
     ...
     * @return
     */
    List<T> list(String statementName);
